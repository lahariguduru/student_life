...
const UserModal1 = ({ onClose }) => {
  return (
    <View style={styles.userModal1}>
      <Text style={styles.matthewLong}>Faith Wilson</Text>
      <Text style={styles.matthewLong}>Faith Wilson</Text>
      <Text style={[styles.skyloft, styles.contactTypo]}>Skyloft</Text>
      <View style={[styles.percent, styles.contactLayout1]}>
        <View style={[styles.drunkPercentage, styles.contactShadowBox]} />
        <Text style={[styles.text, styles.contactPosition]}>35%</Text>
        <Image
          style={styles.userPercentageIcon}
          contentFit="cover"
          source={require("../assets/user-percentage2.png")}
        />
      </View>
